...
$ReleasePath="G:\My Drive\05 - Travail\Revit Dev\TimeStamp\Releases\Current"
$releaseFolder = ($ReleasePath + "\BIM 42 Time Stamper.bundle\Contents\" + $revitVersion + "\")
CopyToFolder $revitVersion $releaseFolder


## Zip the package

$BundleFolder = ($ReleasePath + "\BIM 42 Time Stamper.bundle")
